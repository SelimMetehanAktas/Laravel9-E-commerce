                ...
                <div class="row">
                    <div class="col-md-12 mb-4">
                        <div class="shadow bg-white p-3">
                            ...
                            <hr>
                            <small>* 14 gün içerisinde geri iade.</small>
                            <br />
                            <small>* Taksit imkanlı ödeme.</small>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="shadow bg-white p-3">
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <div class="d-md-flex align-items-start">
                                        <div class="nav col-md-3 flex-column nav-pills me-3" id="v-pills-tab"
                                            ...
                                            <button class="btn btn-outline-secondary">Kapıda Nakit</button>
                                            <br>
                                            <button class="btn btn-outline-secondary">Online Ödeme</button>
                                        </div>
